...
| Core | **Off-ball disruptor** | JKM verbatim: Big Board role and badge; glossary "Weak-side disruptor". | Disrupts away from his own man: holds help position, rotates and recovers on the perimeter, digs at drivers, jumps passing lanes. | off_ball_disruptor ≥ Proficient, any size. Last in every tie, so it is main only when strictly above the other core tiers. | 38 (+24) / 4 (+10) |

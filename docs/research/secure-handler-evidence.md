...
The skill this evidence supports shipped as `secure_handler` and was renamed
to `possession_protector` in [#84](https://github.com/chrooks/Cornerstone/issues/84).
The evidence and stat mapping are unchanged; only the taxonomy key moved.

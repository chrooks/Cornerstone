...
/**
 * LegendsWorkspace — the Legends grid + filter/sort controls as a composable component.
 *
 * Used by:
 *  - `/admin/legends/page.tsx` (standalone — keeps `[legend_id]` sub-route routable)
 *  - `LegendsTab.tsx` (embedded in the Snapshot draft workspace)
 */
...
export function LegendsWorkspace() {
  ...
  if (loading) {
    return (
      <div id="legends-workspace" className="max-w-5xl animate-pulse space-y-4">
  ...
  return (
    <div id="legends-workspace" className="max-w-5xl">
      {/* Page header */}

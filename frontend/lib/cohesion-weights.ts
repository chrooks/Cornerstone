...
export interface CohesionExplanationWeights {
  ...
  DEFENSIVE_REBOUNDING_PRIMARY_WEIGHT: number;
  DEFENSIVE_REBOUNDING_SECONDARY_WEIGHT: number;
  DEFENSIVE_REBOUNDING_DEPTH_WEIGHT: number;
  OFFENSIVE_REBOUNDING_PRIMARY_WEIGHT: number;
  OFFENSIVE_REBOUNDING_SECONDARY_WEIGHT: number;
  OFFENSIVE_REBOUNDING_DEPTH_WEIGHT: number;
  PERIMETER_DEFENSE_PRIMARY_WEIGHT: number;
  PERIMETER_DEFENSE_SECONDARY_WEIGHT: number;
  PERIMETER_DEFENSE_DEPTH_WEIGHT: number;
  INTERIOR_DEFENSE_PRIMARY_WEIGHT: number;
  INTERIOR_DEFENSE_SECONDARY_WEIGHT: number;
  INTERIOR_DEFENSE_DEPTH_WEIGHT: number;
...
export const DEFAULT_COHESION_WEIGHTS: CohesionExplanationWeights = {
  ...
  DEFENSIVE_REBOUNDING_PRIMARY_WEIGHT: 0.45,
  DEFENSIVE_REBOUNDING_SECONDARY_WEIGHT: 0.35,
  DEFENSIVE_REBOUNDING_DEPTH_WEIGHT: 0.2,
  OFFENSIVE_REBOUNDING_PRIMARY_WEIGHT: 0.45,
  OFFENSIVE_REBOUNDING_SECONDARY_WEIGHT: 0.35,
  OFFENSIVE_REBOUNDING_DEPTH_WEIGHT: 0.2,
  PERIMETER_DEFENSE_PRIMARY_WEIGHT: 0.6,
  PERIMETER_DEFENSE_SECONDARY_WEIGHT: 0.3,
  PERIMETER_DEFENSE_DEPTH_WEIGHT: 0.1,
  INTERIOR_DEFENSE_PRIMARY_WEIGHT: 0.6,
  INTERIOR_DEFENSE_SECONDARY_WEIGHT: 0.3,
  INTERIOR_DEFENSE_DEPTH_WEIGHT: 0.1,
...
export function normalizeCohesionExplanationWeights(data: Record<string, unknown> | null | undefined): CohesionExplanationWeights {
  ...
  return {
    ...
    DEFENSIVE_REBOUNDING_PRIMARY_WEIGHT: numberFromWeights(weights, "DEFENSIVE_REBOUNDING_PRIMARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.DEFENSIVE_REBOUNDING_PRIMARY_WEIGHT),
    DEFENSIVE_REBOUNDING_SECONDARY_WEIGHT: numberFromWeights(weights, "DEFENSIVE_REBOUNDING_SECONDARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.DEFENSIVE_REBOUNDING_SECONDARY_WEIGHT),
    DEFENSIVE_REBOUNDING_DEPTH_WEIGHT: numberFromWeights(weights, "DEFENSIVE_REBOUNDING_DEPTH_WEIGHT", DEFAULT_COHESION_WEIGHTS.DEFENSIVE_REBOUNDING_DEPTH_WEIGHT),
    OFFENSIVE_REBOUNDING_PRIMARY_WEIGHT: numberFromWeights(weights, "OFFENSIVE_REBOUNDING_PRIMARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.OFFENSIVE_REBOUNDING_PRIMARY_WEIGHT),
    OFFENSIVE_REBOUNDING_SECONDARY_WEIGHT: numberFromWeights(weights, "OFFENSIVE_REBOUNDING_SECONDARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.OFFENSIVE_REBOUNDING_SECONDARY_WEIGHT),
    OFFENSIVE_REBOUNDING_DEPTH_WEIGHT: numberFromWeights(weights, "OFFENSIVE_REBOUNDING_DEPTH_WEIGHT", DEFAULT_COHESION_WEIGHTS.OFFENSIVE_REBOUNDING_DEPTH_WEIGHT),
    PERIMETER_DEFENSE_PRIMARY_WEIGHT: numberFromWeights(weights, "PERIMETER_DEFENSE_PRIMARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.PERIMETER_DEFENSE_PRIMARY_WEIGHT),
    PERIMETER_DEFENSE_SECONDARY_WEIGHT: numberFromWeights(weights, "PERIMETER_DEFENSE_SECONDARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.PERIMETER_DEFENSE_SECONDARY_WEIGHT),
    PERIMETER_DEFENSE_DEPTH_WEIGHT: numberFromWeights(weights, "PERIMETER_DEFENSE_DEPTH_WEIGHT", DEFAULT_COHESION_WEIGHTS.PERIMETER_DEFENSE_DEPTH_WEIGHT),
    INTERIOR_DEFENSE_PRIMARY_WEIGHT: numberFromWeights(weights, "INTERIOR_DEFENSE_PRIMARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.INTERIOR_DEFENSE_PRIMARY_WEIGHT),
    INTERIOR_DEFENSE_SECONDARY_WEIGHT: numberFromWeights(weights, "INTERIOR_DEFENSE_SECONDARY_WEIGHT", DEFAULT_COHESION_WEIGHTS.INTERIOR_DEFENSE_SECONDARY_WEIGHT),
    INTERIOR_DEFENSE_DEPTH_WEIGHT: numberFromWeights(weights, "INTERIOR_DEFENSE_DEPTH_WEIGHT", DEFAULT_COHESION_WEIGHTS.INTERIOR_DEFENSE_DEPTH_WEIGHT),

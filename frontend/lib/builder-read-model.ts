...
export const SKILL_TO_IMPACT_TRAITS: Record<string, ImpactTraitKey[]> = {
  ...
  off_dribble_shooter: ["spacing", "shot_creation", "pnr_orchestration"],
  high_flyer: ["finishing", "paint_touch", "off_ball_impact", "transition"],
  crafty_finisher: ["finishing", "paint_touch", "off_ball_impact"],
  driver: ["paint_touch", "shot_creation", "pnr_orchestration", "transition"],
  ...
  point_of_attack_defender: ["perimeter_defense"],
  off_ball_disruptor: ["perimeter_defense"],
  versatile_defender: ["perimeter_defense", "interior_defense"],
  steady_hand: ["ball_security"],
  ...
  passer: ["off_ball_impact", "shot_creation", "pnr_orchestration", "transition", "ball_security"],
  pnr_ball_handler: ["shot_creation", "pnr_orchestration"],

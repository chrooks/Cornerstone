...
function SlotCircle({
  ...
  return (
    <div
      ...
      className="flex flex-col items-center gap-0.5 cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md"
    >
      {/* Slot number chip */}
      <div
        className="text-[0.5625rem] font-bold tracking-wider rounded-sm px-1.5 leading-4"
      ...
      <div className="relative" style={{ width: size, height: size }}>
        {isEmpty ? (
          <div
            className="w-full h-full rounded-md flex items-center justify-center text-lg font-light"
          ...
          <div
            className={cn(
              "w-full h-full rounded-md overflow-hidden bg-white transition-all duration-150",
              isFocused && "scale-105",
            )}
            style={{
              boxShadow: isFocused
          ...
          >
            <PlayerHeadshot nba_api_id={occupant.nba_api_id} size={size} name={occupant.name} className="!rounded-md" />
          </div>
        )}
        ...
        {isEmpty ? (
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-0.5">
              <span className="text-[0.5rem] font-semibold tracking-wider text-[#0e0907]/35">
                {occupant.position ?? "—"}
              </span>
              {!isCornerstone && (
                <button
                  ...
                  className="text-[8px] text-[#0e0907]/25 hover:text-[#e53e3e] transition-colors"
...
export function CourtStrip({
  ...
  return (
    <div
      ...
      className="border border-[#d9d0c9] rounded-lg overflow-hidden"
    ...
    >
      ...
      <div className="px-6 py-3 flex items-center justify-center">
        {/* Left label */}
        <div className="flex flex-col items-start mr-5 shrink-0">
        ...
        <div className="flex flex-col items-center mx-5 self-stretch">
